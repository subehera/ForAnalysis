...
void makeEventsFile(int num=20)
{
  string filename = "./outfile/slight.out"; //
  ifstream infile(filename.c_str());
  char outfilename[1000];
  sprintf(outfilename,"slight_%d.lhe",num); 
  //sprintf(outfilename,"slight_alps_5GeV.lhe"); 
...
void ConvertStarlightToLHE(int number_of_files=20) {
